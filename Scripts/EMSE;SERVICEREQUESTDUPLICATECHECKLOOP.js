...
if(bAppTypeMatch)
   vFileDate = "" + vFileDateObj.getMonth() + "/" + vFileDateObj.getDayOfMonth() + "/" +
vFileDateObj.getYear();
if(bAppTypeMatch && dateDiff(vFileDate, sysDateMMDDYYYY) < 3) 
   updateAppStatus("Potential Duplicate","This is a potential duplicate of Record ID: " +
vApp.getCustomID());
