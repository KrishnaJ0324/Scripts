...
if(appStatus == "Permit Issued"){
	var vEventDateFrom = getAppSpecific("Event Date From",capId);
	var vEventDateTo = getAppSpecific("Event Date To",capId);
	
    editAppSpecific("Permit Issued Date", vEventDateFrom); 
    editAppSpecific("Permit Expiration Date", vEventDateTo); 
