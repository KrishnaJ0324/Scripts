...
function fetchData(params) {
  try {
    var url = "https://55a51c441635.ngrok-free.app?params=" + encodeURIComponent(params);

    var httpResponse = aa.httpClient.get(url);

    if (!httpResponse.getSuccess()) {
      logDebug("Error fetching data: " + httpResponse.getErrorMessage());
      return null;
    }
