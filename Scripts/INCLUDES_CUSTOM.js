...
function getAllContactsEmailAddressess(params) {
	// pass in a hashtable and it will add the additional parameters to the table	
	...
	{
		thisContact = contactArray[ca];
		//Preventing adding empty emails.
		if(thisContact["email"] != "")
		{
			contactEmails += thisContact["email"] + ";";	
		}		
	}
	
	addParameter(params, "$$contactEmails$$", contactEmails);
